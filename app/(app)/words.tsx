...
export default function WordsScreen() {
  ...
  return (
    <ScreenContainer scrollable>
      <SectionHeader
        eyebrow="Story 2"
        title="Kelime havuzu ve ekleme modulu"
        description="Kelime, gorsel, ornek cumle ve seviye bilgisiyle havuz yonetimi burada."
      />
      <SurfaceCard>
        ...
        <View style={styles.filters}>
          {levels.map((level) => (
            <Pressable
              ...
              style={[styles.chip, form.level === level ? styles.chipActive : null]}>
      ...
      <SurfaceCard muted>
        ...
        <View style={styles.filters}>
          {["ALL", ...levels].map((level) => (
            <Pressable
              key={level}
              onPress={() => setSelectedLevel(level as WordLevel | "ALL")}
              style={[styles.chip, selectedLevel === level ? styles.chipActive : null]}>
