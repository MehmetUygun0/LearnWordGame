  ...
  return (
    <ScreenContainer scrollable>
      ...
      <SurfaceCard>
        ...
        <Text style={styles.word}>{quizData?.engWordName || 'Yükleniyor...'}</Text>
        <Text style={styles.hint}>Bu kelimenin Türkçe karşılığını aşağıya yaz.</Text>
        ...
        />
        <AppButton label="Cevabı Gönder" onPress={checkAnswer} />
      </SurfaceCard>
